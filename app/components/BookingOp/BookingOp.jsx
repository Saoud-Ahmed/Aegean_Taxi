...
const BookingOp = () => {
  return (
    <div  
      className="px-4 py-20 mt-12 flex flex-col"
      style={{
        backgroundImage:
    ...
    >
      ...
      <div className="text-left pb-10 px-6 ">
        <h1 className="text-3xl mb-4 font-bold leading-[1.1] bg-clip-text text-white">
          How to book your ride with us:
        </h1>
