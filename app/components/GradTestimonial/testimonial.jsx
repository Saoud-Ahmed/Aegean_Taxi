      ...
      >
        {visibleFeedbacks.map((feedback, index) => (
          <div
            ...
            style={{
              backgroundColor: feedback.bgImg ? 'transparent' : feedback.bgColor, // No background color if there is an image
              ...getCardStyles(index),
              backgroundImage: feedback.bgImg ? `url(${feedback.bgImg.src})` : 'none', // Apply the background image only if it's available
