...
export default function WhyBook() {
  return (
    <div className="my-20 flex flex-col overflow-hidden">
      <div className="mx-8">
        {/* Heading Section */}
        ...
        <div className="flex flex-col items-start mt-8 relative "> {/* Added relative positioning */}
          {/* Left vertical line - now positioned within the parent div */}
          <div className="absolute left-12 top-0 bottom-0 w-1 h-[90%] bg-[#000000] z-[-1] "></div>
          ...
          <div className="flex flex-row justify-between items-center mt-6 w-full gap-4">
            <button className="flex-1 bg-black h-[40px] sm:h-[32px] text-white rounded-3xl px-2 sm:px-4 space-x-2 sm:space-x-3 hover:opacity-90 transition whitespace-nowrap flex items-center justify-center">
              <Image src={apple} alt="Online Icon" />
            </button>
