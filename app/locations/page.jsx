      ...
      >
        ...
        <header className="flex items-center justify-between px-3 py-2">
          ...
          <button className="ml-6 h-10 bg-white px-4 py-2 rounded-xl flex items-center border border-black">
            <Image src={AppleStore} alt="App Store" className="w-full h-8" width={100} height={32} />
          </button>
        </header>
        ...
        <div className="relative mt-20 overflow-hidden p-[2px] rounded-t-3xl rounded-b-3xl bg-gradient-to-r from-[#49F352] via-blue-500 to-[#3C00FF] mask-image-[linear-gradient(to top, black, transparent),  linear-gradient(to bottom, black, transparent)] mask-repeat-no-repeat mask-size-[100%_20px, 100%_20px]">          {/* Inner content to preserve padding and background */}
...
<div className="mx-8 pt-6 rounded-xl">
  <div className="relative flex flex-col gap-4">
    ...
    {/* Connecting Line */}
    <div
      className="absolute left-[22px] top-[35px] h-[60px] w-[2px] bg-black  z-20"
    ></div>
              ...
              {cars.map((car, index) => (
                ...
                >
                  <div className="relative mt-8 border rounded-3xl bg-[#E2E6E9] shadow-lg p-4 pl-10 z-0 ">
                    <div className="absolute w-full -top-5 left-6 flex justify-center">
